            ...
            <div className="max-w-4xl mx-auto pt-48 pb-24 px-6 md:px-12">
                ...
                <div className="prose prose-sm md:prose-base max-w-none text-black/70 space-y-8 font-light leading-relaxed tracking-wide">
                    <section className="space-y-4">
                        <h2 className="text-black text-xs font-bold tracking-[0.3em] uppercase font-montserrat-bold">Domestic Shipping (India)</h2>
                        <p>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-black text-xs font-bold tracking-[0.3em] uppercase font-montserrat-bold">International Shipping</h2>
                        <p>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-black text-xs font-bold tracking-[0.3em] uppercase font-montserrat-bold">Tracking Your Order</h2>
                        <p>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-black text-xs font-bold tracking-[0.3em] uppercase font-montserrat-bold">Delivery Issues</h2>
                        <p>
