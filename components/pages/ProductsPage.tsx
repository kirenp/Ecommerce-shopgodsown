        ...
        <div className="max-w-7xl mx-auto flex items-end justify-between gap-6">
          <div>
            ...
            <nav className="flex items-center gap-2 mb-4">
              <span className="text-[10px] text-white tracking-[0.3em] uppercase font-medium">Home</span>
              <span className="text-[10px] text-white">/</span>
              <span className="text-[10px] text-white tracking-[0.3em] uppercase font-medium">Shop</span>
            </nav>
