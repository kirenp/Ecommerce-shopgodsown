            ...
            <div className="max-w-4xl mx-auto pt-48 pb-24 px-6 md:px-12">
                ...
                <div className="prose prose-sm md:prose-base max-w-none text-black/70 space-y-8 font-light leading-relaxed tracking-wide">
                    <section className="space-y-4">
                        ...
                        <p>
                            By accessing and using the <span className="font-geishta">GODS OWN</span> website, you agree to be bound by these Terms of Service
                    ...
                    <section className="space-y-4">
                        ...
                        <p>
                            ...
                            <span className="font-geishta">GODS OWN</span> and protected by intellectual property laws. Unauthorized use of any content is strictly prohibited.
                        </p>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <p>
                            <span className="font-geishta">GODS OWN</span> shall not be liable for any special or consequential damages that result from the use of,
